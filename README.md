...
Вы можете распространять и модифицировать этот текст и использовать в своих целях только при указании авторства.  
...
- 0*0=0  
- 0.1*0.1=0.01  
Результат всегда неотрицательное число. Действительно, пусть aa – произвольное вещественное число. Тогда a*a=a^2≥0. Таким образом, на множестве вещественных чисел, перемножая два одинаковых числа мы всегда получаем неотрицательное число (большее, либо равное нулю).  
