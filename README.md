...
В конспекте использованы примеры и картинки из курсов https://stepik.org/course/58852 и https://stepik.org/course/68343. Первая часть конспекта: Ввод-вывод, Логические операторы и их приоритеты, Типы данных, Циклы, Строки, Списки, Функции, Интересные штуки. Вторая часть конспекта: Тип данных bool и NoneType, Вложенные списки, Кортежи, Множества, Словари, Модули random и string.
# Ввод-вывод
## Базовые команды
