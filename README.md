Вторая часть не закончена и не проверена.
...
- [Модули random и string](#модули-random-и-string)
...
Первая часть конспекта: Ввод-вывод, Логические операторы и их приоритеты, Типы данных, Циклы, Строки, Списки, Функции, Интересные штуки.
Вторая часть конспекта: Тип данных bool и NoneType, Вложенные списки, Кортежи, Множества, Словари, Модули random и string.
# Ввод-вывод
## Базовые команды
...
```
## Методы строк
Методы к строкам применяются так:
строка.метод
...
```
## Матрицы
🛈 Тема не полностью раскрыта в конспекте
